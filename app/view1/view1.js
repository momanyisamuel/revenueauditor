...
.controller('View1Ctrl', ['$scope','$http','getData','$rootScope',function($scope, $http, getData, $rootScope) {
    var ctrl= $rootScope;
    var month = 1;
    var year = 2015;
    var cdata = [];
    ...
    $http.get('http://yauro.co.za/banking/ajax/dbconnect.jsp?'+
    'ajax=selectbranch&branchid='+branchId).then(function (data) {
      ...
      getData.getChartData(month,year, branchId).then(function (d) {
          ...
          //  }
            ...
            for (var i = 0; i < d.data.data.length; i++) {
              ...
              computedData.push(d.data.data[i].variance);
